...
const PRODUCTS = [
  ...
  {
    name: "Yogabar",
    tagline: "Crunchy Peanut Butter",
    origin: "100% Natural",
    process: "No Added Sugar",
    story: "Made with real peanuts and flax seeds. Crunchy, natural, and packed with honest nutrition for your daily ritual.",
    micro: "High Protein · Clean Label",
    image: "/products/yogabar.png",
    alt: "Yogabar Crunchy Peanut Butter jar",
    slug: "yogabar-crunchy-peanut-butter",
    accent: "rgba(200, 140, 40, 0.05)",
  },
  {
    name: "Organic Cosmos",
